...
export default function Portal404() {
  return (
    <div className={styles.container}>
      ...
      >
        <p>Похоже, здесь энергосеть пустует 🚫🔌</p>
        <p>Вернитесь на стартовую и вновь включите свет!</p>
      </motion.div>
    </div>
  );
}
...
// const icon = {
//   hidden: { opacity: 0, pathLength: 0, fill: "rgba(227,112,33,0)" },
//   visible: { opacity: 1, pathLength: 1, fill: "rgba(227,112,33,1)" },
// };
...
//         >
//           Кажется, вы открыли портал в пустоту.
//         </Typography.Text>
//       </motion.div>
//     </div>
//   );
